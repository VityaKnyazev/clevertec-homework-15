...
public class PassportTestData {
    ...
    private static final String EXPECTED_AND_INPUT_OUTPUT_PASSPORT_UUID = "1c8d196b-5b76-40c8-b3f5-7bccb8a43d45";
    private static final String EXPECTED_AND_INPUT_OUTPUT_PASSPORT_SERIES ="KB";
    private static final String EXPECTED_AND_INPUT_OUTPUT_PASSPORT_NUMBER = "1256398";
    ...
    public static Passport expectedPassport() {
        return Passport.builder()
                ...
                .uuid(UUID.fromString(EXPECTED_AND_INPUT_OUTPUT_PASSPORT_UUID))
                .passportSeries(EXPECTED_AND_INPUT_OUTPUT_PASSPORT_SERIES)
                .passportNumber(EXPECTED_AND_INPUT_OUTPUT_PASSPORT_NUMBER)
    ...
    public static GetPassportResponseDTO expectedPassportResponseDTO() {
        return GetPassportResponseDTO.builder()
                .uuid(EXPECTED_AND_INPUT_OUTPUT_PASSPORT_UUID)
                .passportSeries(EXPECTED_AND_INPUT_OUTPUT_PASSPORT_SERIES)
                .passportNumber(EXPECTED_AND_INPUT_OUTPUT_PASSPORT_NUMBER)
